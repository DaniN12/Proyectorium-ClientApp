...
public class ProviderClient {
    ...
    public <T> T listByContractEnd(Class<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path("listByContractEnd");
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T listByContractInit(Class<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public <T> T listByPrice(Class<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
